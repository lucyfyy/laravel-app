...
@section('content')
    ...
    <form method="POST" action="{{ $action }}" id="myform">
        ...
        <input type="text" id="datepicker" name="tanggal" placeholder="tanggal"><br>
        <!-- <input type="submit" value="{{ $store }}" /> -->
        <div class="send_bt" id="btn-save">
            <!-- <input class="send_bt" type="submit" value="Simpan"> -->
            <a href="#" onclick="document.getElementById('myform').submit()">Simpan</a>
        </div>
        <div class="send_bt">
